  ...
  <div class="container">
    <div class="material-band-grid">
      <div class="material-stat">
        <div class="num">12<span class="suf"></span></div>
        <div class="label">Offload Stations · Apache Nitrogen Spur</div>
      </div>
  ...
  <div class="container">
    ...
    <ul class="proj-list">
      <li>
        ...
        <div class="proj-scope">New rail spur, 3 terminations, 12 offload stations integrated with storage and piping scope</div>
      </li>
      <li>
        <div class="proj-meta">Multiple Industrial Offload & Chemical Facility Rail Projects<span class="proj-loc">Southwest & Intermountain West</span></div>
        <div class="proj-scope">Spur work, transload facilities, and emergency rerailing across multiple owners</div>
      </li></ul>
  </div>
</section>
