...
<title>Instrumentation & Electrical</title>
  ...
  <div class="container">
    <div class="material-band-grid">
      <div class="material-stat">
        <div class="num">275,000<span class="suf"> LF</span></div>
        <div class="label">Cable · Single Jervois Project</div>
      </div>
  ...
  <div class="container">
    ...
    <ul class="proj-list">
      <li>
        ...
        <div class="proj-scope">(3) MCC buildings, 8,000 LF Victaulic/welded SS piping, all I&E</div>
      </li>
      <li>
        <div class="proj-meta">Jervois<span class="proj-loc">Salmon, ID</span></div>
        <div class="proj-scope">275,000 LF cable, 30,000 power terminations, 800 instruments</div>
      </li>
      <li>
        <div class="proj-meta">Apache Nitrogen<span class="proj-loc">St. David, AZ</span></div>
        <div class="proj-scope">All instrumentation and controls, 7,500 LF pipe and pumps</div>
      </li>
      <li>
        <div class="proj-meta">Simplot / Linde<span class="proj-loc">Rock Springs, WY</span></div>
        <div class="proj-scope">I&E plant commissioning, agro-chemical facility</div>
      </li></ul>
  </div>
</section>
